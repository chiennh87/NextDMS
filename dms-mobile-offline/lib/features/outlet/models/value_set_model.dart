...
/// Model cho dữ liệu địa chỉ (tỉnh/huyện/xã)
class AddressModel extends Equatable {
  ...
  factory AddressModel.fromJson(Map<String, dynamic> json) {
    return AddressModel(
      id: json['id'] is int ? json['id'] : int.tryParse(json['id']?.toString() ?? '0'),
      code: json['province_code']?.toString() ?? json['district_code']?.toString() ?? json['ward_code']?.toString(),
      name: json['province_name']?.toString() ?? json['district_name']?.toString() ?? json['ward_name']?.toString(),
      parentCode: json['province_code']?.toString() ?? json['district_code']?.toString(),
